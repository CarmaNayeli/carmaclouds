...
(() => {
  ...
  var init_spell_edge_cases = __esm({
    "../core/src/modules/spell-edge-cases.js"() {
      "use strict";
      SPELL_EDGE_CASES = {
  ...
  var init_class_feature_edge_cases = __esm({
    "../core/src/modules/class-feature-edge-cases.js"() {
      "use strict";
  ...
  var init_racial_feature_edge_cases = __esm({
    "../core/src/modules/racial-feature-edge-cases.js"() {
      "use strict";
  ...
  var init_combat_maneuver_edge_cases = __esm({
    "../core/src/modules/combat-maneuver-edge-cases.js"() {
      "use strict";
...
`;
  ...
  var init_action_announcements = __esm({
    "../core/src/modules/action-announcements.js"() {
      "use strict";
      (function() {
        "use strict";
  ...
  var init_character_trait_popups = __esm({
    "../core/src/modules/character-trait-popups.js"() {
      "use strict";
      (function() {
        "use strict";
  ...
  var init_character_traits = __esm({
    "../core/src/modules/character-traits.js"() {
      "use strict";
      (function() {
        "use strict";
  ...
  var init_companions_manager = __esm({
    "../core/src/modules/companions-manager.js"() {
      "use strict";
      (function() {
        "use strict";
  ...
  var init_concentration_tracker = __esm({
    "../core/src/modules/concentration-tracker.js"() {
      "use strict";
      (function() {
        "use strict";
  ...
  // ../core/src/browser.js
  var import_debug, import_html_utils, import_theme_manager, import_client, import_indexeddb_cache, import_card_creator, import_color_utils;
  var init_browser = __esm({
    "../core/src/browser.js"() {
      "use strict";
      import_debug = __toESM(require_debug());
      init_browser_polyfill();
      import_html_utils = __toESM(require_html_utils());
      import_theme_manager = __toESM(require_theme_manager());
      init_config();
      import_client = __toESM(require_client());
      import_indexeddb_cache = __toESM(require_indexeddb_cache());
      init_spell_edge_cases();
      init_class_feature_edge_cases();
      init_racial_feature_edge_cases();
      init_combat_maneuver_edge_cases();
      init_action_executor();
      init_action_announcements();
      init_action_display();
      init_action_filters();
      init_action_options();
      import_card_creator = __toESM(require_card_creator());
      init_character_trait_popups();
      init_character_traits();
      import_color_utils = __toESM(require_color_utils());
      init_companions_manager();
      init_concentration_tracker();
      init_data_manager();
      init_dice_roller();
      if (typeof window !== "undefined") {
  ...
  var owlcloud_popup_exports = {};
  var browserAPI3;
  var init_owlcloud_popup = __esm({
    "src/popup/adapters/owlcloud/owlcloud-popup.js"() {
      init_browser();
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        if (typeof browserAPI3 === "undefined" && typeof window.browserAPI === "undefined") {
    ...
    `;
        ...
        const storage = {
          async get(keys) {
            return new Promise((resolve, reject) => {
              try {
                const result = browserAPI3.storage.local.get(keys);
    ...
    `;
        ...
        function initializePopup() {
          ...
          async function checkDiscordResyncPrompt() {
            try {
              const stored = await browserAPI3.storage.local.get(["requireDiscordResync"]);
              if (stored && stored.requireDiscordResync) {
                ...
                if (resyncBtn)
                  resyncBtn.addEventListener("click", async () => {
                    try {
                      await browserAPI3.storage.local.remove("requireDiscordResync");
                    } catch (e) {
          ...
          async function checkLoginStatus() {
            try {
              ...
              const response = await Promise.race([
                browserAPI3.runtime.sendMessage({ action: "checkLoginStatus" }),
              ...
              try {
                const result = await browserAPI3.storage.local.get(["diceCloudToken", "username", "tokenExpires"]);
                ...
                if (result.diceCloudToken) {
                  ...
                  debug.log("\u274C No token found in storage, checking Supabase...");
                  const { explicitlyLoggedOut } = await browserAPI3.storage.local.get("explicitlyLoggedOut");
                  if (explicitlyLoggedOut) {
                  ...
                  try {
                    if (typeof window.SupabaseTokenManager !== "undefined") {
                      ...
                      if (supabaseResult.success) {
                        ...
                        await browserAPI3.storage.local.remove("explicitlyLoggedOut");
                        showMainSection();
                      } else {
          ...
          async function handleSessionConflict(sessionCheck) {
            try {
              ...
              await browserAPI3.storage.local.remove([
                "diceCloudToken",
                "username",
                "tokenExpires",
                "diceCloudUserId",
          ...
          async function handleAutoConnect() {
            try {
              ...
              hideLoginError();
              if (!browserAPI3 || !browserAPI3.tabs || typeof browserAPI3.tabs.query !== "function") {
                showLoginError("Extension error: tabs API not available. Please reload the extension.");
                return;
              }
              const [activeTab] = await browserAPI3.tabs.query({ active: true, currentWindow: true });
              ...
              if (activeTab && activeTab.url && activeTab.url.includes("dicecloud.com")) {
                ...
                const tabs = await browserAPI3.tabs.query({ url: "https://dicecloud.com/*" });
                if (tabs.length > 0) {
                  dicecloudTab = tabs[0];
              ...
              if (dicecloudTab) {
                ...
                try {
                  ...
                  if (response && response.success && response.token) {
                    ...
                    try {
                      if (browserAPI3 && browserAPI3.tabs && typeof browserAPI3.tabs.update === "function") {
                        await browserAPI3.tabs.update(dicecloudTab.id, { active: true });
                      }
                    } catch (tabError) {
                ...
                try {
                  if (browserAPI3 && browserAPI3.tabs && typeof browserAPI3.tabs.create === "function") {
                    await browserAPI3.tabs.create({
          ...
          async function handleLogout() {
            try {
              ...
              await browserAPI3.runtime.sendMessage({ action: "logout" });
              showLoginSection();
              clearCharacterDisplay();
              showDiscordNotConnected();
            } catch (error) {
          ...
          async function loadCharacterData() {
            try {
              ...
              const profiles = profilesResponse.success ? profilesResponse.profiles : {};
              const storageResult = await browserAPI3.storage.local.get(["activeCharacterId"]);
              ...
              if (activeCharacterId && profiles[activeCharacterId]) {
                ...
                const activeResponse = await browserAPI3.runtime.sendMessage({ action: "getCharacterData" });
                activeCharacter = activeResponse.success ? activeResponse.data : null;
              }
          ...
          async function displayCharacterData(data) {
            ...
            try {
              const loginStatus = await browserAPI3.runtime.sendMessage({ action: "checkLoginStatus" });
          ...
          async function handleSync() {
            try {
              ...
              if (selectedId) {
                ...
                const profilesResponse = await browserAPI3.runtime.sendMessage({ action: "getAllCharacterProfiles" });
                const profiles = profilesResponse.success ? profilesResponse.profiles : {};
                let characterData2 = profiles[selectedId];
                if (characterData2) {
                  ...
                  const result = await browserAPI3.runtime.sendMessage({
          ...
          async function refreshFromDatabase() {
            try {
              ...
              const supabaseManager = new window.SupabaseTokenManager();
              const result = await browserAPI3.storage.local.get(["diceCloudToken", "username", "tokenExpires", "diceCloudUserId", "authId"]);
              if (!result.diceCloudToken) {
              ...
              if (supabaseResult.success) {
                ...
                const characterData2 = await supabaseManager.getCharacterData(result.diceCloudUserId);
                if (characterData2.success && characterData2.characters) {
                  console.log(`Pulled ${Object.keys(characterData2.characters).length} characters from cloud`);
                  await mergeCloudDataToLocal(characterData2.characters);
                }
              } else {
          ...
          async function mergeCloudDataToLocal(cloudCharacters) {
            try {
              const localResponse = await browserAPI3.runtime.sendMessage({ action: "getAllCharacterProfiles" });
        ...
        `;
          ...
          async function handleSlotSelection(slotId, tab) {
            try {
              ...
              const response = await browserAPI3.tabs.sendMessage(tab.id, {
          ...
          async function handleShowSheet() {
            try {
              ...
              const [tab] = await browserAPI3.tabs.query({ active: true, currentWindow: true });
              const profilesResponse = await browserAPI3.runtime.sendMessage({ action: "getAllCharacterProfiles" });
              const profiles = profilesResponse.success ? profilesResponse.profiles : {};
          ...
          function handleHowTo() {
            if (typeof browser !== "undefined" && browser.runtime && browser.runtime.openOptionsPage) {
              ...
              const welcomeUrl = browserAPI3.runtime.getURL("src/options/welcome.html");
              browserAPI3.tabs.create({ url: welcomeUrl });
            }
          }
...
Local data will also be removed.`)) {
          ...
          async function handleImport(event) {
            ...
            try {
              ...
              let importedCount = 0;
              for (const [characterId, characterData2] of Object.entries(importData.characters)) {
                await browserAPI3.runtime.sendMessage({
                  action: "storeCharacterData",
                  data: characterData2,
                  slotId: characterId
          ...
          async function loadAutoBackwardsSyncState() {
            try {
              const result = await browserAPI3.storage.local.get(["autoBackwardsSync"]);
          ...
          async function handleAutoBackwardsSyncToggle() {
            try {
              ...
              await browserAPI3.storage.local.set({ autoBackwardsSync: isEnabled });
          ...
          async function loadDiscordConnectionState() {
            try {
              const response = await browserAPI3.runtime.sendMessage({ action: "getDiscordWebhook" });
          ...
          async function checkIfSessionMatches() {
            try {
              const { currentSessionId } = await browserAPI3.storage.local.get(["currentSessionId"]);
              if (!currentSessionId) {
          ...
          async function handleSetupDiscord() {
            try {
              ...
              try {
                ...
                await browserAPI3.runtime.sendMessage({ action: "requestPairingCodeFromInstaller" });
                await new Promise((resolve) => setTimeout(resolve, 500));
                const stored = await browserAPI3.storage.local.get(["installerPairingCode"]);
                if (stored.installerPairingCode) {
                  ...
                  await browserAPI3.storage.local.remove(["installerPairingCode"]);
                }
              } catch (e) {
              ...
              if (!installerProvided && diceCloudUserId) {
                const storeResult = await browserAPI3.runtime.sendMessage({
            ...
            pairingPollInterval = setInterval(async () => {
              ...
              try {
                ...
                if (result.success && result.connected && result.webhookUrl) {
                  ...
                  const setResult = await browserAPI3.runtime.sendMessage({
          ...
          async function handleCheckDiscordIntegration() {
            ...
            try {
              ...
              const result = await browserAPI3.storage.local.get(["activeCharacterId", "characterProfiles", "diceCloudUserId"]);
  ...
  async function init(containerEl) {
    ...
    try {
      ...
      const { default: initOwlCloud } = await Promise.resolve().then(() => (init_owlcloud_popup(), owlcloud_popup_exports));
