(() => {
  ...
  (function() {
    "use strict";
    debug.log("\u{1F3B2} FoundCloud: Custom sheet overlay loaded");
    ...
    function loadCharacterData() {
      debug.log("\u{1F504} Loading character data from storage...");
      browserAPI.runtime.sendMessage({ action: "getCharacterData" }, (response) => {
        ...
        if (response && response.data) {
          ...
          showNotification("Character data synced! \u{1F3B2}", "success");
        } else {
    ...
    function addRollEventListeners() {
      document.querySelectorAll(".ability-card").forEach((card) => {
        card.addEventListener("click", (e) => {
          ...
          debug.log(`\u{1F3B2} Clicked ability card: ${name} (${roll})`);
      ...
      document.querySelectorAll(".spell-card").forEach((card) => {
        card.addEventListener("click", (e) => {
          e.stopPropagation();
          debug.log("\u{1F52E} Spell card clicked, checking data attributes...");
          ...
          debug.log(`\u{1F52E} Clicked spell: ${spellName} (Level ${spellLevel}) - Action: ${clickAction}`);
          debug.log("\u{1F52E} Spell description:", spellDescription);
          debug.log("\u{1F52E} Posting spell description to chat");
          ...
          if (clickAction === "rollAttack") {
            ...
            debug.log("\u{1F52E} Rolling spell attack:", spellAttackRoll);
      ...
      document.querySelectorAll(".skill-card").forEach((card) => {
        card.addEventListener("click", (e) => {
          ...
          debug.log(`\u{1F3B2} Clicked skill card: ${skillName} (${skillBonus})`);
      ...
      if (initiativeBtn) {
        initiativeBtn.addEventListener("click", (e) => {
          ...
          debug.log(`\u{1F3B2} Initiative check: 1d20+${initiative}`);
